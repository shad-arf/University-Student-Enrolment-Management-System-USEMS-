        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="dashboard.php">
              ...
              <h3 class="brand-text"><img src="https://upload.wikimedia.org/wikipedia/ckb/5/54/Soran_University_Logo.png" alt="Girl in a jacket" width="50"> Soran University</h3>
            </a>
          </li>
...
<?php 
$qury = mysqli_query($con, "SELECT tbladmapplications.id as appid, student_data.Name from tbladmapplications join student_data on student_data.Code=tbladmapplications.userId where status='pending'");
$num=mysqli_num_rows($qury);
?>

 <li class="dropdown dropdown-notification nav-item">
              <a class="nav-link nav-link-label" href="./pending-application.php" data-toggle="dropdown"><i class="ficon ft-bell"></i>
...
$yui =mysqli_query($con ,"SELECT * from tbladmapplications where status='pending'");
while ($row=mysqli_fetch_array($yui)) {


?>
<a href="view-appform.php?aticid=<?php echo $row['userId'];?>">
                    <div class="media">
